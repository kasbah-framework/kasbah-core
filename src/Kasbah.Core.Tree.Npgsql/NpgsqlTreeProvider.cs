...
using Npgsql;
using static Kasbah.Core.Tree.Npgsql.Utils.SerialisationUtil;

namespace Kasbah.Core.Tree.Npgsql
{
    public class NpgsqlTreeProvider : ITreeProvider, IDisposable
    {
        ...
        public NpgsqlTreeProvider(ILoggerFactory loggerFactory)
        {
            _log = loggerFactory.CreateLogger<NpgsqlTreeProvider>();
