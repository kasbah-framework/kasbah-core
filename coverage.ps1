...
[string[]] $Projects = "Kasbah.Core", "Kasbah.Core.Tree.Npgsql", "Kasbah.Core.Events", "Kasbah.Core.Index", "Kasbah.Core.Index.Solr", "Kasbah.Core.Events.Redis", "Kasbah.Core.Tree", "Kasbah.Core.ContentBroker", ""
